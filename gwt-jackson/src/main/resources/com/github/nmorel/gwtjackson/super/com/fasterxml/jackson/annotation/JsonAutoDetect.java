...
//        }
            ...
            java.io.Serializable
    {
        ...
        public String toString() {
            return "JsonAutoDetect.Value(fields=" + _fieldVisibility + ",getters=" + _getterVisibility + ",isGetters=" + _isGetterVisibility + ",setters=" + _setterVisibility + ",creators=" + _creatorVisibility + ")";
        }
